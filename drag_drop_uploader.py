...
class DragDropUploader:
    ...
    def create_gui(self):
        ...
        # Drop zone
        drop_frame = ttk.LabelFrame(main_frame, text="Drop Zone", padding="20")
        drop_frame.grid(row=0, column=0, sticky=(tk.W, tk.E), pady=(0, 10))
        drop_frame.columnconfigure(0, weight=1)
        
        drop_label = ttk.Label(drop_frame, text="📁 Drag & Drop APK Files Here", 
                              font=('Arial', 14, 'bold'),
                              anchor=tk.CENTER)
        drop_label.grid(row=0, column=0, pady=20)
        
        self.status_label = ttk.Label(drop_frame, text="Initializing...", 
                                     font=('Arial', 10),
                                     anchor=tk.CENTER)
        ...
        # Link frame
        link_frame = ttk.LabelFrame(main_frame, text="Public Link", padding="10")
        link_frame.grid(row=1, column=0, sticky=(tk.W, tk.E), pady=(0, 10))
        link_frame.columnconfigure(0, weight=1)
        
        self.link_entry = ttk.Entry(link_frame, font=('Arial', 10))
